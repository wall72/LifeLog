...
@implementation RatingBasisViewController

@synthesize ratingBasis = __ratingBasis;
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.keys = [self.ratingBasis.allKeys sortedArrayUsingSelector:@selector(compare:)];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([[self.ratingBasis objectForKey:_key] boolValue]) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (_row != _oldRow) {
        ...
        [self.ratingBasis setObject:@"1" forKey:_key];
        ...
        [self.ratingBasis setObject:@"0" forKey:_key];
